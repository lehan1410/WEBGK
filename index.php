...
<body class="">
            ...
            <nav id="navbar" class="navbar">
                ...
                <div class="wc-btn">
                    ...
                    <div class="logged-in-user" style="display:flex">
                        <a style="margin-left:30px;color:#fff" href="/WEBGK/view/logout.php"
                            class="btn btn-primary">Logout</a>
                        <p style="margin-right:30px; color:#fff"> Welcome, <?php echo $user_name; ?>!</p>
                    </div>
                    <?php else : ?>
                    <div class="wc-btn">
                        <a style="color:#fff" href="/WEBGK/view/login.php" class="btn btn-primary">Login</a>
                    </div>
                    <?php endif; ?>
                </div>
            </nav>
    ...
    <div class="main">
        ...
        <div class="page">
            ...
            <section class="wc-help" style="background-color: white;">
                <div class="container">
            ...
            <!-- <!====== Start-wc_latest-section =======> -->
            <section class="wc-latest">
                <div class="container">
